...
public class DownloadHelper {
    ...
    // kar
    public DownloadBundle download(String url) throws HttpResponseException, IOException {
        ...
        try {
            ...
            String contentType = httpTransferClient.download(url, tmpFile);

            return new DownloadBundle(
                    null, contentType, null, tmpFile);
        } catch (Exception e) {
            tmpFile.delete();
            throw e;
        }
